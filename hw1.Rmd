---
title: "HW1"
author: "Nicholas Matthews; Github: nickmatthews713"
date: "1/15/2020"
...
### My paragraph:  
I think a job related to data science would be **finding patterns among consumer purchases and consumer attributes** for a specific advertising company. By using market data to find what types of consumers (Male, Female, old, young) buy certain products, *the advertising company could make their advertisements appeal to the correct audiences, leading to greater prophit.* Here is a picture of my schedule and [Here is a link](https://github.com/nicholasmatthews713/ds202_hw1.git) to my github repository for this assignment
![image of my schedule](Nick_Schedule.jpg).
...
## Github Username: nickmatthews713
